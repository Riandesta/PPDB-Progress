                        ...
                        <tbody>
                            @foreach ($pendaftars as $index => $pendaftar)
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="badge bg-{{ $pendaftar->status_seleksi === 'Lulus'
                                                ? 'success'
                                                : ($pendaftar->status_seleksi === 'Pending'
                                                    ? 'warning'
                                                    : 'danger') }}">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            @if ($pendaftar->foto)
                                                <div class="text-center mb-3">
                                                    <img src="{{ Storage::url($pendaftar->foto) }}" alt="Foto Siswa"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <p><strong>Jenis Kelamin:</strong> {{ $pendaftar->jenis_kelamin }}
                                                    </p>
                                                </div>
                                                <div class="col-md-6">
                                                    <p><strong>Asal Sekolah:</strong> {{ $pendaftar->asal_sekolah }}
                                                    </p>
                                                    <p><strong>Agama:</strong> {{ $pendaftar->agama }}</p>
                                                    <p><strong>Tahun Ajaran:</strong> {{ $pendaftar->tahun_ajaran_id }}
                                                    </p>
                                                    <p><strong>Nama Orang Tua:</strong> {{ $pendaftar->nama_ortu }}</p>
                                                    <p><strong>Pekerjaan Orang Tua:</strong>
                                                        {{ $pendaftar->pekerjaan_ortu }}</p>
                                                    <p><strong>No Telepon Orang Tua:</strong>
                                                        {{ $pendaftar->no_telp_ortu }}</p>
                                                </div>
                                            </div>
                                        </div>
